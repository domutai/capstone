...
// const ManageTablesModal = ({ club, onClose }) => {
...
//EDIT MODAL WORKS BUT ADD AND DELETE ARE GONE
// import { useState, useEffect } from 'react';
// import './ManageTablesModal.css';
...
//                   <input type="text" placeholder="Table Name" value={newTable.table_name} onChange={(e) => setNewTable({ ...newTable, table_name: e.target.value })} />
//                   {errors.table_name && <p className="error">{errors.table_name}</p>}
//                   <input type="number" placeholder="Price" value={newTable.price} onChange={(e) => setNewTable({ ...newTable, price: e.target.value })} />
//                   {errors.price && <p className="error">{errors.price}</p>}
//                   <input type="number" placeholder="Capacity" value={newTable.capacity} onChange={(e) => setNewTable({ ...newTable, capacity: e.target.value })} />
//                   {errors.capacity && <p className="error">{errors.capacity}</p>}
//                   <input type="text" placeholder="Image URL" value={newTable.image_url} onChange={(e) => setNewTable({ ...newTable, image_url: e.target.value })} />
//                   {errors.image_url && <p className="error">{errors.image_url}</p>}
